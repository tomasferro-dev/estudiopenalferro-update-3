...
// import logo from "../../assets/images/logo.png"; // ajustá la ruta si hace falta
  ...
  return (
    <footer className="bg-[#1A1918] text-[#D4CDB8]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <Scale className="text-[#C4A259]" size={28} />
          ...
          <p className="text-sm leading-relaxed text-[#BFB8A2]">
            Estudio jurídico especializado en derecho penal, litigación estratégica
            y asesoramiento legal integral. Comprometidos con la defensa técnica,
            la confidencialidad y el ejercicio ético de la profesión.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <a href="#bienvenido" className="hover:text-[#C4A259] transition">
                Inicio
              </a>
            </li>
            <li>
              <a href="#sobre-nosotros" className="hover:text-[#C4A259] transition">
                Sobre el Estudio
              </a>
            </li>
            <li>
              <a href="#areas" className="hover:text-[#C4A259] transition">
                Áreas de Práctica
              </a>
            </li>
            <li>
              <a href="#contacto" className="hover:text-[#C4A259] transition">
                Contacto
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+5492616589732" className="hover:text-[#C4A259] transition">
                +54 9 261 658 9732
              </a>
            </li>
      ...
      <div className="border-t border-[#C4A259]/20 py-6 text-center text-xs text-[#BFB8A2]">
        © {new Date().getFullYear()} Estudio Penal Ferro — Todos los derechos reservados.
      </div>
    </footer>
  );
}
