import { ShieldCheck, Scale, Binary, ChevronRight, ChevronLeft, ChevronDown } from 'lucide-react';
...
const scrollToSection = (id) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full grid grid-cols-[1fr_auto] items-center px-10">
        ...
        >
          <div className="w-12 h-12 bg-[#C4A259] flex items-center justify-center">
      ...
      >
        <p className="text-[#E6DDC6] leading-relaxed">
          {description}
        </p>
  ...
  <div className="absolute bottom-3 left-4 z-10">
    ...
    return (
        <section
  id="areas"
  className="relative py-24 lg:py-32 bg-cover bg-center scroll-mt-[90px]"
  style={{
    backgroundImage: `
      linear-gradient(
        to right,
                  ...
                  <div className="relative max-w-5xl mx-auto px-6 lg:px-12">
                    ...
                    <div className="text-center mb-16">
                      ...
                      <p className="text-[#D4CDB8] max-w-3xl mx-auto text-base md:text-lg leading-relaxed">
                        En Ferro y Asociados nos Destacamos por nuestra Excelencia y Seriedad ante cada una 
                        de las siguientes Áreas del Derecho, para Encontrar la Mejor Solución a tu Problema.
                      </p>
                         <button onClick={() => scrollToSection('contacto')}>Contactanos Hoy</button>
                    </div>
