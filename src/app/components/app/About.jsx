...
export default function About() {
  return (
    <section id="sobre-nosotros" className="py-20 lg:pt-32 pb-8">
          ...
          <div>
            ...
            <div className="space-y-6 text-white leading-relaxed">
              <p className="text-base md:text-lg">
                El estudio jurídico se encuentra a cargo de la abogada Josefina
                Ferro, quien es egresada de la Facultad de Derecho de la
                Universidad Nacional de Cuyo.
              </p>
              <p className="text-base md:text-lg">
                Ejerce defensa particular en causas penales por delitos de
                competencia provincial o federal.
              </p>
              <p className="text-base md:text-lg">
                Se especializa en cyberdelito y litigación penal en sistema
                adversarial.
              </p>
            </div>
            <button
